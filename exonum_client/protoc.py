...
class Protoc:
    ...
    def _modify_file(path: str, modules: List[str]) -> None:
        ...
        if "/exonum/proof/" in path or "/exonum/runtime/" in path:
            modify_main_nested_file(path)
            return

        if "/exonum/" in path:
            modify_main_file(path)
            return

        modify_service_file(path, modules)
...
def modify_main_file(path: str) -> None:
...
def modify_main_nested_file(path: str) -> None:
    # This function modifies imports in files generated by protoc to be relative.
...
def modify_service_file(path: str, modules: List[str]) -> None:
    # This function modifies imports in files generated by protoc to be relative.
